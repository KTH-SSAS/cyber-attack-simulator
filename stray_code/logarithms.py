...
joint_probs = [joint_prob(p, p_xy) for p, p_xy in zip(conditional_probabilites, conditional_probabilites)]

for i in range(4):
	conditional_entropy += joint_prob(conditional_probabilites[i], )
