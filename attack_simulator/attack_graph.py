...
class AttackGraph:
    ...
    def reset(self):
        ...
        if self.graph_size == 'large':
            ...
            self.attack_steps['wifi_network.decrypt_traffic'] = AttackStep(step_type='and', ttc=5, children={
            ...
            self.attack_steps['sea_turtle.escalate_to_root'] = AttackStep(ttc=50, children={
        ...
        if self.graph_size == 'medium' or self.graph_size == 'large':
            ...
            if self.graph_size == 'large':
                ...
                self.attack_steps['energetic_bear.capture_traffic'] = AttackStep(
            ...
            self.attack_steps['lazarus.flag_cd699a.capture'] = AttackStep(
                reward=self.early_flag_reward, deterministic=self.deterministic)
            if self.graph_size == 'large':
                self.attack_steps['lazarus.find_credentials'] = AttackStep(ttc=10, children={
