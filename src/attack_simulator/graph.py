...
class AttackGraph:
    ...
    def reset(self):
        ...
        if self.graph_size == "large":
            ...
            self.add_attack_step(
                ...
                ttc=self.easy_ttc,
                children={"wifi_host.http_server.flag_18dd8f.capture"},
            )
            self.add_attack_step(
                asset="wifi_host",
                service="http_server",
            ...
            self.add_attack_step(
                ...
                name="map",
                ttc=self.easy_ttc,
                children={"wifi_host.http_server.connect"},
            )
            self.add_attack_step(
                asset="wifi_network", name="connect", step_type="and", children={"wifi_network.map"}
            )
            self.add_attack_step(
                asset="wifi_network",
                flag="flag_d582aa",
            ...
            self.add_attack_step(
                asset="wifi_network",
                name="decrypt_traffic",
                step_type="and",
                ttc=self.easy_ttc,
                children={"wifi_network.flag_d582aa.capture"},
            )
            self.add_attack_step(
                asset="wifi_network",
                name="obtain_credentials",
                ttc=self.easy_ttc,
                children={"wifi_network.connect", "wifi_network.decrypt_traffic"},
            )
            self.add_attack_step(
                asset="wifi_network",
            ...
            self.add_attack_step(
                ...
                children={
                    ...
                    "wifi_network.find_credentials",
                    "wifi_network.decrypt_traffic",
                },
            )
            ...
            self.add_attack_step(
                ...
                name="gather_information",
                ttc=self.easy_ttc,
                children={"wifi_network.capture_traffic"},
            )
            ...
            self.add_attack_step(
                ...
                name="login",
                step_type="and",
                children={"fancy_bear.gather_information"},
            )
            self.add_attack_step(
                asset="fancy_bear",
                service="ssh",
            ...
            self.add_attack_step(
                asset="fancy_bear", service="ssh", name="connect", children={"fancy_bear.ssh.login"}
            )

            self.add_attack_step(
                asset="cloud_function",
                flag="flag_831865",
                name="capture",
                reward=self.late_flag_reward,
            )
            ...
            self.add_attack_step(
                ...
                name="gather_information",
                children={
                    "cloud_function.find_vulnerability",
                    "cloud_function.flag_d8d9da.capture",
                },
            )
            ...
            self.add_attack_step(
                ...
                name="list",
                children={
                    "cloud_function.gather_information",
                    "cloud_bucket.find_credentials",
                    "cloud_bucket.flag_21077e.capture",
                },
            )
            ...
            self.add_attack_step(
                ...
                name="exploit_vulnerability",
                ttc=self.easy_ttc,
                children={"cloud_hopper.terminal_access"},
            )
            self.add_attack_step(
                asset="cloud_hopper",
                service="smb",
                name="find_vulnerability",
                ttc=self.easy_ttc,
                children={"cloud_hopper.smb.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="cloud_hopper",
                service="smb",
            ...
            self.add_attack_step(
                asset="hidden_network",
                name="map",
                ttc=self.easy_ttc,
                children={"cloud_hopper.smb.connect", "fancy_bear.ssh.connect"},
            )
            self.add_attack_step(
                asset="hidden_network", name="connect", children={"hidden_network.map"}
            )

            self.add_attack_step(
                asset="buckeye", flag="flag_2362e5", name="capture", reward=self.late_flag_reward
            )
            self.add_attack_step(
                asset="buckeye", flag="flag_5d402e", name="capture", reward=self.late_flag_reward
            )
            self.add_attack_step(
                asset="buckeye",
                service="firefox",
            ...
            self.add_attack_step(
                ...
                name="exploit_vulnerability",
                ttc=self.easy_ttc,
                children={"buckeye.escalate_to_root"},
            )
            self.add_attack_step(
                asset="buckeye",
                name="find_vulnerability",
                ttc=self.easy_ttc,
                children={"buckeye.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="buckeye",
                name="terminal_access",
            ...
            self.add_attack_step(
                ...
                name="exploit_vulnerability",
                ttc=self.easy_ttc,
                children={"buckeye.terminal_access"},
            )
            self.add_attack_step(
                asset="buckeye",
                service="firefox",
                name="find_vulnerability",
                ttc=self.easy_ttc,
                children={"buckeye.firefox.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="buckeye",
                service="firefox",
            ...
            self.add_attack_step(
                asset="sea_turtle", flag="flag_6be6ef", name="capture", reward=self.late_flag_reward
            )
            self.add_attack_step(
                asset="sea_turtle", flag="flag_f9038f", name="capture", reward=self.late_flag_reward
            )
            self.add_attack_step(
                asset="sea_turtle",
                name="capture_traffic",
                ttc=self.easy_ttc,
                children={"buckeye.firefox.connect", "buckeye.firefox.flag_14ce18.capture"},
            )
            self.add_attack_step(
                asset="sea_turtle",
                name="escalate_to_root",
                ttc=self.hard_ttc,
                children={"sea_turtle.capture_traffic", "sea_turtle.flag_6be6ef.capture"},
            )
            self.add_attack_step(
                asset="sea_turtle",
                name="exploit_vulnerability",
                ttc=self.hard_ttc,
                children={"sea_turtle.escalate_to_root"},
            )
            self.add_attack_step(
                asset="sea_turtle",
                name="find_vulnerability",
                ttc=self.hard_ttc,
                children={"sea_turtle.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="sea_turtle",
                service="telnet",
                name="login",
                step_type="and",
                children={"sea_turtle.find_vulnerability", "sea_turtle.flag_f9038f.capture"},
            )
            self.add_attack_step(
                asset="sea_turtle",
                service="telnet",
        ...
        if self.graph_size == "medium" or self.graph_size == "large":
            ...
            if self.graph_size == "large":
                ...
                self.add_attack_step(
                    asset="energetic_bear", name="capture_traffic", ttc=self.easy_ttc, children={}
                )
            ...
            self.add_attack_step(
                ...
                name="escalate_to_root",
                ttc=self.easy_ttc,
                children={"energetic_bear.capture_traffic", "energetic_bear.flag_73cb43.capture"},
            )
            self.add_attack_step(
                asset="energetic_bear",
                name="exploit_vulnerability",
                ttc=self.hard_ttc,
                children={"energetic_bear.escalate_to_root"},
            )
            self.add_attack_step(
                asset="energetic_bear",
                name="find_vulnerability",
                ttc=self.hard_ttc,
                children={"energetic_bear.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="energetic_bear",
                name="terminal_access",
                ttc=self.easy_ttc,
                children={
                    "energetic_bear.find_vulnerability",
                    "energetic_bear.flag_3b2000.capture",
                },
            )
            ...
            self.add_attack_step(
                ...
                name="exploit_vulnerability",
                ttc=self.easy_ttc,
                children={"energetic_bear.terminal_access", "energetic_bear.flag_de3b1c.capture"},
            )
            self.add_attack_step(
                asset="energetic_bear",
                service="apache",
                name="find_vulnerability",
                ttc=self.hard_ttc,
                children={"energetic_bear.apache.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="energetic_bear",
                service="apache",
                ...
                ttc=self.easy_ttc,
                children={
                    "energetic_bear.apache.find_vulnerability",
                    "energetic_bear.apache.flag_521bce.capture",
                },
            )
            self.add_attack_step(
                asset="energetic_bear",
            ...
            self.add_attack_step(
                asset="lazarus", flag="flag_cd699a", name="capture", reward=self.early_flag_reward
            )
            if self.graph_size == "large":
                self.add_attack_step(
                    asset="lazarus",
                    name="find_credentials",
                    ttc=self.easy_ttc,
                    children={"sea_turtle.telnet.obtain_credentials"},
                )
            else:
                self.add_attack_step(asset="lazarus", name="find_credentials", ttc=self.easy_ttc)
            self.add_attack_step(
                asset="lazarus",
                name="terminal_access",
                children={
                    "lazarus.find_credentials",
                    "lazarus.flag_cd699a.capture",
                    "lazarus.ftp.flag_adcb1f.capture",
                },
            )
            ...
            self.add_attack_step(
                ...
                name="exploit_vulnerability",
                ttc=self.easy_ttc,
                children={"lazarus.terminal_access"},
            )
            self.add_attack_step(
                asset="lazarus",
                service="tomcat",
                name="find_vulnerability",
                ttc=self.easy_ttc,
                children={"lazarus.tomcat.exploit_vulnerability"},
            )
            self.add_attack_step(
                asset="lazarus",
                service="tomcat",
                ...
                ttc=self.easy_ttc,
                children={
                    "lazarus.tomcat.find_vulnerability",
                    "lazarus.tomcat.flag_90b353.capture",
                },
            )
            self.add_attack_step(
                asset="lazarus",
                ...
                name="gather_information",
                ttc=self.easy_ttc,
                children={"lazarus.tomcat.dictionary_attack"},
            )
            self.add_attack_step(
                asset="lazarus",
                service="tomcat",
        ...
        if self.graph_size == "small":
            self.add_attack_step(
                ...
                name="map",
                ttc=self.easy_ttc,
                children={"lazarus.ftp.connect"},
            )

        self.add_attack_step(
            asset="office_network", name="connect", children={"office_network.map"}
        )
        self.add_attack_step(asset="internet", name="connect", children={"office_network.connect"})
    ...
    def add_attack_step(
        self, asset="", service="", flag="", name="", step_type="or", ttc=1, reward=0, children={}
    ):
        id_string = ""
        id_string += asset
        if service != "":
        ...
        if flag != "":
            id_string += "." + flag
        id_string += "." + name
        self.attack_steps[id_string] = AttackStep(
            name=name,
            asset=asset,
            service=service,
            flag=flag,
    ...
    def disable(self, service):
        ...
        for subservice in self.enabled_services:
            if (
                self.enabled_services[subservice]
                and service in subservice
                and service != subservice
            ):
