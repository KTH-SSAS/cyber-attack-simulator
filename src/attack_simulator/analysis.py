...
class Analyzer():
    ...
    def effect_of_hidden_layer_size_on_return(self, training_episodes=10000, evaluation_episodes=100):
        ...
        # Plot the surface.
        surf = ax.plot_surface(hls_array, gs_array, returns_matrix, cmap=cm.coolwarm,
    ...
    def effect_of_size_on_returns(self, training_episodes=10000, evaluation_episodes=100, random_seed_min=0, random_seed_max=1):
        ...
        n_attack_steps = [7, 29, 78]*(random_seed_max-random_seed_min) # TODO These shouldn't be hard-coded here.
