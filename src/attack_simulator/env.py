...
class AttackSimulationEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.service_state = np.full(self.g.num_services, 1, dtype='int8')
        self.attack_state = np.full(self.g.num_attacks, 0, dtype='int8')
        self.attack_surface = np.full(self.g.num_attacks, 0, dtype='int8')
